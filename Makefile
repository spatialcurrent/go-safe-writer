...
imports: bin/goimports ## Update imports in Go source code
	...
	bin/goimports -w -local github.com/spatialcurrent/go-safe-writer,github.com/spatialcurrent $$(find . -iname '*.go')

vet: ## Vet Go source code
	go vet github.com/spatialcurrent/go-safe-writer/pkg/... # vet packages
